...
```bash
$ comunica-mcp-sparql-hdt --mode http --port 3123 --timeout 300000
```
...
```bash
$ comunica-mcp-sparql-hdt --mode http --port 3123 --workers 4
```
...
```bash
$ comunica-mcp-sparql-hdt --mode http --port 3123 --max-result-bytes 200000
```
